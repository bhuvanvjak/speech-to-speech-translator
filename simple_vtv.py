...
def audio_transcription(audio_file):
    ...
    aai.settings.api_key = "a712f11ad86b488fa9225c013823d281"
...
def text_translation(text):
    ...
    translator_es = Translator(from_lang="en", to_lang="hi")
...
def text_to_speech(text):
    ...
    client = ElevenLabs(
        api_key= "sk_06edc2750e52b4116534d9c94508d2ecce5ce48e12879e5b",
    )

    # Calling the text_to_speech conversion API with detailed parameters
    response = client.text_to_speech.convert(
        voice_id="vghiSqG5ezdhd8F3tKAD", #clone your voice on elevenlabs dashboard and copy the id
...
demo = gr.Interface(
    fn=voice_to_voice,
    inputs=audio_input,
    outputs=[gr.Audio(label="Hindi"), gr.Audio(label="Turkish"), gr.Audio(label="Japanese")]
)
